...
const addSlot = () => {
  ...
  setWeeklyAvailability(prev => {
    const updatedSlots = [...prev[selectedDay], { start: startTime, end: endTime }];
...
<div className='mt-6'>
  <p className='font-medium mb-2'>Weekly Availability</p>
  ...
  <div className='flex flex-wrap gap-2 mb-3'>
    {Object.keys(weeklyAvailability).map(day => (
      <button
        ...
        className={`px-4 py-1 rounded border ${selectedDay === day ? 'bg-primary text-white' : 'bg-white'}`}
      >
        {day}
      </button>
    ))}
